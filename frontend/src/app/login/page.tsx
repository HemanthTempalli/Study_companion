    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 400 }} className="animate-in">
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13.5, color: 'var(--color-text-3)' }}>Sign in to your learning workspace</p>
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--color-text-3)', marginTop: 20 }}>
          ...
          <Link href="/register" style={{ color: 'var(--color-accent)', textDecoration: 'none', fontWeight: 500 }}>Create one</Link>
        </p>
      </div>
    </div>
  );
